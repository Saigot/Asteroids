...
public class PauseMenu extends StandardGame {
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
        ...
        g.fillRoundRect((float) (gc.getWidth() * 0.15), (float) (gc.getHeight() * 0.15),
                (float) (gc.getWidth() * 0.75), (float) (gc.getHeight() * 0.75), 50);
        g.setColor(Color.white);

        //measure string width
        String[] instr = {"Instructions", "Use the arrow keys to move",
