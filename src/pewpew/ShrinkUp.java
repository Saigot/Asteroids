...
public class ShrinkUp extends PowerUps{
    ...
    public ShrinkUp(float X, float Y, float SIZE) throws SlickException {
        ...
        try {
            sound = AudioLoader.getAudio("OGG",
                    ResourceLoader.getResourceAsStream("Res/Sounds/ShrinkUpOn.ogg"));
        } catch (IOException ex) {
            Logger.getLogger(BulletNormal.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void Death(byte conditions) {
        try {
            sound = AudioLoader.getAudio("OGG",
                    ResourceLoader.getResourceAsStream("Res/Sounds/ShrinkUpOff.ogg"));
        } catch (IOException ex) {
            Logger.getLogger(BulletNormal.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (collided) {
